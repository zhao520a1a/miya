...
<div id="o-header-2013">
    <div class="w" id="header-2013">
        <div id="logo-2013" class="ld"><a href="javascript:index()" hidefocus="true"
                                          clstag="homepage|keycount|home2013|02a"><b></b><img
                src="/images/miya-logo.png" width="270" height="60" alt="Miya"></a></div>
        <!--logo end-->
        <div id="search-2013">
            ...
            <dl>
                <dt class="ld">
                    ...
                    <a href="javascript:showMyInfo()"
                       clstag="homepage|keycount|home2012|04a">我的Miya</a>
                    <b></b>
                </dt>
                <%--<dd>--%>
        ...
        <div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
            <dl>
                <dt class="ld">
                    <s></s>
                    <%--<span class="shopping">--%>
                    <%--<span id="shopping-amount"></span></span>--%>
                    <a href="javascript:showCart()" id="settleup-url">去购物车结算</a>
                    <b></b>
                </dt>
                <!-- 				<dd>
                                    <div class="prompt">
                ...
                <div id="_JD_ALLSORT" class="mc">
                    <div class="item fore1">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(1)">图书、音像、电子书刊</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore2">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(74)">家用电器</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore3">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(161)">电脑、办公</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore4">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(249)">个护化妆</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore5">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(290)">钟表</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore6">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(296)">母婴</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore7">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(378)">食品饮料、保健食品</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore8">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(438)">汽车用品</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore9">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(495)">玩具乐器</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore10">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(558)">手机</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore11">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(580)">数码</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore12">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(633)">家居家装</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore13">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(699)">厨具</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="item fore14">
						<span data-split="1"><h3>
								<a href="javascript:showProducts(749)">服饰内衣</a>
							</h3>
							<s></s></span>
                    </div>
                    <div class="extra">
