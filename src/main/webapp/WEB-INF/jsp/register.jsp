...
<div class="w2" id="regist">
    <div class="mt">
        ...
        <div class="extra">
        <span>我已经注册，现在就&nbsp;
        	<a href="http://www.miya.com:8084/user/showLogin" class="flk13">登录</a>
        </span>
        </div>
    </div>
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《Miya用户注册协议》</a></label>
                        <span class="clr"></span>
            ...
            <img width="300" height="390" src="/images/reg.gif">
            <%--</div>--%>
            <span class="clr"></span>
        </form>
    </div>
