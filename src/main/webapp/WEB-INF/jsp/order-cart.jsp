...
<head>
    ...
    <%--<script type="text/javascript" src="/js/miya.js" charset="utf-8"></script>--%>
</head>
<body  class="root61">
...
<form id="orderForm" class="hide" action="/create" method="post">
    ...
    <c:forEach items="${cartList}" var="cart" varStatus="status">
        ...
        <input type="hidden" name="orderItems[${status.index}].item_id" value="${cart.id}"/>
        ...
        <input type="hidden" name="orderItems[${status.index}].total_fee" value="${cart.price * cart.num}"/>
        <input type="hidden" name="orderItems[${status.index}].title" value="${cart.title}"/>
        <input type="hidden" name="orderItems[${status.index}].pic_path" value="${cart.image}"/>
    </c:forEach>
    <input type="hidden" name="payment"
           value="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/100 }"/>"/>
    <input type="hidden" name="orderShipping.receiver_name" value="赵小鑫"/>
    <input type="hidden" name="orderShipping.receiver_mobile" value="15891588888"/>
    <input type="hidden" name="orderShipping.receiver_state" value="北京"/>
    <input type="hidden" name="orderShipping.receiver_city" value="北京"/>
    <input type="hidden" name="orderShipping.receiver_district" value="朝阳区"/>
    <input type="hidden" name="orderShipping.receiver_address" value="大望路 xxxxxxxxx"/>
</form>
                                ...
                                <ul class="ui-switchable-panel-main" id="consignee-list">
                                    ...
                                    <li class="ui-switchable-panel" id="consignee_index_137617472"
                                        ...
                                        <div class="consignee-item item-selected"
                                            ...
                                            <div class="user-name">
                                                <div class="fl">
                                                    <strong limit="4">赵小鑫</strong>&nbsp;&nbsp;收
                                                </div>
                                                <div class="fr">158****8888</div>
                                                <div class="clr"></div>
                                            </div>
                                            <div class="mt10" limit="15">北京 朝阳区 五环外六环里</div>
                                            <div class="adr-m" limit="30">大望路 xxxxxxxxx</div>
                    ...
                    <div id="shipAndSkuInfo">
                        <div id="payShipAndSkuInfo">
                            ...
                            <div class="step-tit">
                                <h3>送货清单</h3>
                                <div class="extra-r">
                                    <a href="javascript:showCart()" id="cartRetureUrl" class="return-edit ftx-05">返回修改购物车</a>
                                </div>
                            </div>
                                ...
                                <div class="shopping-lists" id="shopping-lists">
                                    <div class="shopping-list ABTest">
                                        <div class="goods-list">
                                            <!--配送方式-->
                                            <h4 class="vendor_name_h" id="0">商家：Miya商城</h4>
                                            <div class="goods-suit goods-last">
                                                <c:forEach items="${cartList }" var="cart">
                                                    <div class="goods-item goods-item-extra">

                                                        <div class="p-img">
                                                            <a target="_blank" href="javascript: showItem(${cart.id})">
                                                    ...
                                                    <ul>
                                                        <li class="mode-tab-item " id="jd_shipment_item"
                                                            onclick="doSwithTab('pay')"><span
                                                                id="jdShip-span-tip" class="m-txt">Miya快递<i
                                                                class='qmark-icon qmark-tip'
                                                                data-tips='由Miya公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="sticky-wrap">
                            <div class="inner">
                                ...
                                <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
                                    部分商品货到付款方式：先由Miya配送“提货单”并收款，然后厂商发货。
                                </div>
                            </div>
