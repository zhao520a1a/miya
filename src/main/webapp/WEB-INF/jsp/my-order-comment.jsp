                        ...
                        <div class="mc">
                            <div class="tb-void tb-line">
                                <table class="tb-void tb-line">
                                    ...
                                    <c:forEach items="${itemsInfo}" var="item" varStatus="status">
                                        <tr>
                                            <td>
                                                <div class="p-name fl">
                                                    <a
                                                            href="javascript:showItem(${item.item_id})">${item.title}</a>
                                                </div>
                                            </td>
                                            <td>
                                                <a
                                                        href="javascript:showItem(${item.item_id})">
                                                    <img width="50" height="50" title="${item.title}"
                                                         data-img="1" src="${item.pic_path}"
                                                         class="err-product">
                                                </a>
                                            </td>

                                            <td>
                                                <span class="ftx03">￥${item.price/100}</span>
                                            </td>

                                            <td>
                                                <span class="ftx03">${item.num}</span>
                                            </td>
                                            <td>
                                                <span class="ftx03">￥${item.total_fee/100}</span>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                        ...
                        <div class="comment-box prompt01" oid="3122336930" pid="975788"
                            ...
                            <div class="form" tagflag="true" isconspros="0" pid="975788">
                                ...
                                <div class="item tagEl" style="">
                                    ...
                                    <div class="fl">
                                        <ul class="tips-list">
                                            <li vid="132"><s class="f-check"></s>速度快</li>
                                            <li vid="128"><s class="f-check"></s>质量也不错</li>
                                            <li vid="131"><s class="f-check"></s>便宜</li>
                                            <li vid="135"><s class="f-check"></s>使用方便</li>
                                            <li vid="136"><s class="f-check"></s>介绍详细</li>
                                            <li vid="134"><s class="f-check"></s>效果不错</li>
                                            <li vid="133"><s class="f-check"></s>功能齐全</li>
                                            <li vid="129"><s class="f-check"></s>效果不错</li>
                                            <li vid="137"><s class="f-check"></s>值得购买</li>
                                            <li class="list-last">
