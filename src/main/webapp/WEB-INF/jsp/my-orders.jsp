        ...
        <div id="main">
                ...
                <div id="content" class="c-3-5">
                    <div class="mod-main mod-comm" id="order01">
                        ...
                        <div class="mc" id="order01">
                            <dl>
                                <dt>便利提醒：</dt>
                                <dd id="ordercount-waitPay" clstag="click|keycount|orderinfo|waitPay">待付款( ${totalCount}
                                    )
                                </dd>
                        ...
                        <div class="mc">
                            <table class="tb-void">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <select id="submitDate" name="" class="sele">
                                            ...
                                            <option value="2013">2017年</option>
                                            <option value="2012">2016年</option>
                                            <option value="2011">2015年</option>
                                ...
                                <c:forEach items="${orderInfo}" var="order" varStatus="status">
                                    <tbody id="${order.order_id}">
                                    <tr class="tr-th">
                                        <td colspan="6">
                                     <span class="tcol1">
                                  订单编号:
                              <a name="orderIdLinks"
                                 href="javascript:showOrderItems(${order.order_id})"
                                 clstag="click|keycount|orderinfo|order_num">${order.order_id}</a>
		    		                </span>
                                            <span class="tcol2"> Miya   </span>
                                            <span class="tcol3">  <a class="btn-im" onclick="getPamsForChat()"
                                    ...
                                    <tr id="track2538292730" oty="0,1,70" class="tr-td">
                                        ...
                                        <td id="operate2538292730" class="order-doi" width="100">
                                            ...
                                            <a href="javascript:showOrderItems(${order.order_id})"
                                               clstag="click|keycount|orderinfo|order_check">查看</a><span
                                                id="order_comment"></span><span class="pop-recycle-a">|<a
                                                href="javascript:(0)" clstag="click|keycount|orderinfo|order_del"
                            ...
                            <div class="pagin fr">
                                <c:if test="${totalPages>1}">
                                    <c:if test="${currPage>1}">
                                        <a href="http://order.miya.com:8090/my-orders?currPage=${currPage-1}"
                                    ...
                                    <c:forEach var="index" begin="${startIndex}" end="${endIndex}" step="1">
                                        <c:if test="${index==currPage}">
                                            <a href="http://order.miya.com:8090/my-orders?currPage=${index}"
                                               style="color: #C38700">${index}</a>
                                        </c:if>
                                        <c:if test="${index!=currPage}">
                                            <a href="http://order.miya.com:8090/my-orders?currPage=${index}">${index}</a>
                                        </c:if>
                                    </c:forEach>
            ...
            <div id="left" class="g-3-5 c-0">
                ...
                <div id="menu"><h3>我的交易</h3>
                    <dl class="fore1">
                        <dt><a clstag="homepage|keycount|home2013|hdd" id="_MYJD_ordercenter"
                               href="javascript:showMyOrders()" class="curr">我的订单</a></dt>
                    </dl>
                    <dl class="fore2">
                    ...
                    <dl class="fore8">
                        ...
                        <dd class="fore2">
                            <div class="item" id="_MYJD_credit"><a clstag="homepage|keycount|home2013|hbt" tag="213"
                                                                   href="http://baitiao.jd.com/creditUser/record">Miya白条</a>&nbsp;
                            </div>
                        </dd>
                        <dd class="fore3">
                            <div class="item" id="_MYJD_tx"><a target="_blank" clstag="homepage|keycount|home2013|htx"
                                                               href="http://mobile.jd.com/yyswt/myjd.do">Miya通信</a>
                            </div>
                        </dd>
                        <dd class="fore4">
                        ...
                        <dd class="fore6">
                            <div class="item" id="_MYJD_card"><a target="_blank" clstag="homepage|keycount|home2013|he"
                                                                 href="http://giftcard.jd.com/giftcard/index.action">Miya卡</a>
                            </div>
                        </dd>
                        <dd class="fore7 last">
                            <div class="item" id="_MYJD_bean"><a target="_blank" clstag="homepage|keycount|home2013|hjd"
                                                                 href="http://bean.jd.com/myJingBean/list">Miya币</a></div>
                        </dd>
                    </dl>
                    <dl class="fore9 last ">
