...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/miya.css"/>
...
<div class="w">
    <div id="logo">
        <a href="http://localhost:8082" clstag="passport|keycount|login|01">
            <img src="/images/miya-logo.png" alt="Miya商城" width="270" height="60"/>
        </a><b></b>
    </div>
</div>
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            ...
            <div id="entry-bg" clstag="passport|keycount|login|02"
                 style="width: 511px; height: 455px; position: absolute; left: -1px; top: -50px; background: url(/images/bg1.png) 0px 0px no-repeat;">
            </div>
        ...
        <div class="free-regist">
            <span><a href="javascript:regist()" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
        ...
        doLogin: function () {
            $.post("/user/login", $("#formlogin").serialize(), function (data) {
                if (data.responseModal.code == 1) {
                    alert("登录成功！");
                    if (redirectUrl == "") {
                        location.href = "http://www.miya.com:8082";
                    } else {
                        location.href = redirectUrl;
                    }
                } else {
                    alert("登录失败，原因是：" + data.responseModal.msg);
                    $("#loginname").select();
                }
            }, "json");
        },
