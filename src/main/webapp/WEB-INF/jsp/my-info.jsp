...
<head>
    ...
    <link href="/css/miya.css" type="text/css" rel="stylesheet"/>
</head>
<body>
                ...
                <div id="content" class="c-3-5">
                    ...
                    <div class="mod-main">
                        ...
                        <div class="mc">
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" readOnly="true" class="itxt" maxlength="20" id="nickName"
                                                   name="userVo.nickName" value="${userInfo.username}">
                                            <div class="clr"></div>
                                        ...
                                        <div class="fl">
                                            <div class="fl">
                                                <input type="text" class="itxt" maxlength="20" name="userVo.realName"
                                                       id="realName" value="${userInfo.phone}" readOnly="true">
                                                <div class="clr"></div>
                                                <div class="prompt-06"><span id="realName_msg"></span></div>
                                            </div>
                                            <div>
                                                <strong> ${userInfo.email}
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" name="userVo.realName"
                                                   id="realName" value="${userInfo.phone}">
                                            <div class="clr"></div>
                                            <div class="prompt-06"><span id="realName_msg"></span></div>
                                        </div>
                                    </div>
                            ...
                            <div id="user-info">
                                <div class="u-pic">
                                    <img alt="用户头像" src="/images/defaultImgs/4.jpg">
                                    <div class="mask"></div>
                ...
                <div id="menu"><h3>我的交易</h3>
                    <dl class="fore1">
                        <dt><a clstag="homepage|keycount|home2013|hdd" id="_MYJD_ordercenter"
                               href="javascript:showMyOrders()">我的订单</a></dt>
                    </dl>
                    <dl class="fore2">
