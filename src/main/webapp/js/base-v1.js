...
function goToOrder() {
    return location.href = "http://order.miya.com:8089/order-cart";
}
function goToOrder() {
    return location.href = "http://order.miya.com:8089/order-cart";
}
...
//搜索模块
function search(a) {
    var b = "http://www.miya.com:8810/search?q=" + encodeURIComponent(document.getElementById(a).value);
