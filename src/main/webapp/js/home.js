...
(function () {
    ...
    new BackPanelNew({id: "backpanel0708", start: 10}).init({
        ...
        var t = $("#shortcut-2013 .fl").eq(0).find(".fore1"),
            e = '            <li class="fore2 jd-wx-qrcode">                <a href="#none"><i class="i-qrcode"></i>关注MIYA</a>                <div class="qrcode-show">                    <span class="arrow">                        <i class="layer1"></i><i class="layer2"></i>                    </span>                </div>            </li>';
