...
var category = {
    OBJ: $("#_JD_ALLSORT"),
    URL_Serv: "http://itemCat.miya.com:8087/itemCats/all?callback=category.getDataService",
    ...
    FN_GetLink: function (a, b) {
        ...
        // return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://item.miya.com:8086" + c ), '<a href="' + c + '">' + d + "</a>")
        return "" == c ? d : '<a href="' + c + '">' + d + "</a>"
    },
