...
public class ItemServiceImpl extends BaseCURDService<Item,ItemDao> implements ItemService {
	...
	@Override
	public ResponseModal addItem(Item item, String desc, String itemParam) throws Exception {
		//item补全
		//生成商品ID
		// '商品状态，1-正常，2-下架，3-删除',
		//插入到数据库
	 ...
	 * 添加商品描述
	 */
	private ResponseModal insertItemDesc(Long itemId, String desc) {
	 ...
	 * 添加规格参数
	 */
	private ResponseModal insertItemParamItem(Long itemId, String itemParam) {
		//创建一个pojo
